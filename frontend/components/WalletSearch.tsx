...
const DEFAULT_REAL_CANDIDATES: CandidateWallet[] = [
  ...
  {
    id: 4,
    address: 'TUeapnPqxRyQB2hePL2mSsm5HEZc7aSiwE',
    chain: 'tron',
    discovery_source: 'vasp_counterparty_miner',
    discovery_vasp_name: 'Binance',
    discovery_vasp_address: 'TDqSquXBgUCLYvYC4XZgrprLK589dkhSCf',
    discovered_at: '2026-08-26T05:00:00Z',
    last_analyzed_at: '2026-08-26T05:00:00Z',
    transaction_count: 40,
    token_transfers_count: 26,
    unique_counterparties_count: 24,
    usdt_volume: 15700.0,
    usdc_volume: 0.0,
    total_volume_usd: 15700.0,
    active_days: 12,
    incoming_tx_count: 15,
    outgoing_tx_count: 25,
    incoming_volume: 7850.0,
    outgoing_volume: 7850.0,
    reachable_vasps: [
      { name: 'Binance', min_hop: 1, direct_tx_count: 5, flow_volume_usd: 15700.0, paths_count: 5 },
    ],
    min_hop_to_vasp: 1,
    reachable_vasp_count: 1,
    total_paths_to_vasps: 5,
    candidate_quality_score: 79.6,
    status: 'investigation_ready',
  },
];
