      ...
      <section id="overview" className="relative overflow-hidden pt-20 pb-20 md:pt-28 md:pb-28 border-b border-border">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-[0.12] dark:opacity-[0.18]">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Ambient nodes */}
            <circle cx="20%" cy="30%" r="4" fill="#E5484D" />
            <circle cx="28%" cy="45%" r="3" fill="#A8AFBA" />
            <circle cx="45%" cy="25%" r="4" fill="#39B982" />
            <circle cx="75%" cy="35%" r="3" fill="#A8AFBA" />
            <circle cx="85%" cy="60%" r="5" fill="#39B982" />
            <line x1="20%" y1="30%" x2="28%" y2="45%" stroke="#272A31" strokeWidth="1.5" />
            <line x1="28%" y1="45%" x2="45%" y2="25%" stroke="#272A31" strokeWidth="1.5" />
            <line x1="45%" y1="25%" x2="75%" y2="35%" stroke="#272A31" strokeWidth="1.5" />
            <line x1="75%" y1="35%" x2="85%" y2="60%" stroke="#272A31" strokeWidth="1.5" />
          </svg>
        </div>
