  ...
  return [
    {
      ...
      style: {
        label: 'data(label)',
        color: isDarkMode ? '#F5F7FA' : '#111318',
        ...
        'text-valign': 'center',
        'text-halign': 'center',
        'background-color': isDarkMode ? '#17191E' : '#FFFFFF',
        'border-width': 2,
        'border-color': isDarkMode ? '#363A43' : '#D0D5DD',
        width: 58,
        height: 58,
    ...
    },
    {
      ...
      style: {
        'background-color': isDarkMode ? '#221316' : '#FEF2F2',
        'border-color': '#E5484D',
        'border-width': 3,
        color: isDarkMode ? '#FFA5A8' : '#991B1B',
        width: 68,
        height: 68,
        'font-weight': 700,
        'font-size': '11px',
    ...
    },
    {
      ...
      style: {
        'background-color': isDarkMode ? '#0E241B' : '#ECFDF5',
        'border-color': '#39B982',
        'border-width': 3,
    ...
    },
    {
      ...
      style: {
        ...
        'background-color': isDarkMode ? '#1E222B' : '#F8FAFC',
    ...
    },
    {
      ...
      style: {
        'border-color': isDarkMode ? '#363A43' : '#CBD5E1',
        'background-color': isDarkMode ? '#17191E' : '#F1F5F9',
    ...
    },
    {
      ...
      style: {
        'border-color': isDarkMode ? '#272A31' : '#E2E8F0',
        'background-color': isDarkMode ? '#111317' : '#F8F9FA',
        color: isDarkMode ? '#A8AFBA' : '#475569',
      },
    },
    {
      selector: 'edge',
      style: {
        width: 2,
        'line-color': isDarkMode ? '#363A43' : '#CBD5E1',
        ...
        color: isDarkMode ? '#A8AFBA' : '#475467',
        'text-rotation': 'autorotate',
        'text-background-opacity': 0.96,
        'text-background-color': isDarkMode ? '#111317' : '#FFFFFF',
        'text-background-padding': '3px',
        'text-background-shape': 'roundrectangle',
        'text-border-color': isDarkMode ? '#272A31' : '#E2E5E9',
        'text-border-width': 1,
